# -*- coding: utf-8 -*-
"""
Created on Thu Nov 25 12:40:47 2021
...
# colon_n
hu_Moments_colon_n = Moments(imggray_colon_n)
data1_Moments_colon_n = data_Moments(hu_Moments_colon_n)

data1_colon_n = pd.concat([data_Mean_colon_n, data_std_colon_n, data_Med_colon_n, data_quantile_colon_n, data2_contrast_colon_n, data2_dissimilarity_colon_n, data2_homogeneity_colon_n, data2_energy_colon_n, data2_correlation_colon_n, data2_asm_colon_n, data2_Moments_colon_n], axis=1)
...
data1_colon_n['target'] = colon_n


# colon_aca
hu_Moments_colon_aca = Moments(imggray_colon_aca)
data2_Moments_colon_aca = data_Moments(hu_Moments_colon_aca)

data2_colon_aca = pd.concat([data_Mean_colon_aca, data_std_colon_aca, data_Med_colon_aca, data_quantile_colon_aca, data1_contrast_colon_aca, data1_dissimilarity_colon_aca, data1_homogeneity_colon_aca, data1_energy_colon_aca, data1_correlation_colon_aca, data1_asm_colon_aca, data1_Moments_colon_aca], axis=1)
...
data2_colon_aca['target'] = colon_aca

data_colon = data1_colon_n.append(data2_colon_aca)

Datas_colon = shuffle(data_colon)
Datas_colon = round(Datas_colon,3)
...
X_train_colon, X_test_colon, Y_train_label_colon, Y_test_label_colon = train_test_split(X_colon,Y_colon,test_size = 0.2,random_state=0)
...
test_X_colon = pd.DataFrame(X_test_colon, columns=['Mean', 'Std', 'Median', 'Percentile 25%', 'Percentile 50%', 'Percentile 75%','Contrast1', 'Contrast2', 'Contrast3', 'Contrast4', 'dissimilarity1','dissimilarity2', 'dissimilarity3', 'dissimilarity4', 'homogeneity1','homogeneity2', 'homogeneity3', 'homogeneity4', 'energy1', 'energy2','energy3', 'energy4', 'correlation1', 'correlation2', 'correlation3','correlation4', 'asm1', 'asm2', 'asm3', 'asm4', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'h7'])

rf_colon = RandomForestClassifier(n_estimators=300, random_state=0)
rf_colon.fit(X_train_colon,Y_train_colon)

explainer = shap.TreeExplainer(rf_colon)
shap_values = explainer.shap_values(test_X_colon)

shap.summary_plot(shap_values[1], test_X_colon, plot_type="bar")
shap.summary_plot(shap_values[1], test_X_colon, plot_type="bar", 
                  color=['blue','blue','blue', 'green', 'blue','green', 
                         'blue','blue', 'green','blue', 'red', 'green',
                         'blue','blue','blue','red','blue', 'red','red','red'])

shap.summary_plot(shap_values[1], test_X_colon, feature_names = test_X_colon.columns)


def cancer_risk_factors(model, patient):
    explainer = shap.TreeExplainer(rf_colon)
    shap_values = explainer.shap_values(patient)
    shap.initjs()
    return shap.force_plot(explainer.expected_value[1], shap_values[1], patient, matplotlib = True, show = True)

data_for_prediction_colon = test_X_colon.iloc[1,:].astype(float)
cancer_risk_factors(rf_colon, data_for_prediction_colon)

data_for_prediction_array_colon = data_for_prediction_colon.values.reshape(1, -1)
rf_colon.predict_proba(data_for_prediction_array_colon)
