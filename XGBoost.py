# -*- coding: utf-8 -*-
"""
Created on Mon Sep 27 10:48:48 2021
...
print("Training set score for XGBoost: %f" % rfe.score(X_train_scaled, Y_train))
print("Testing  set score for XGBoost: %f" % rfe.score(X_test_scaled, Y_test ))
