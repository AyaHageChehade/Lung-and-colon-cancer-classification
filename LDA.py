# -*- coding: utf-8 -*-
"""
Created on Mon Sep 27 13:58:07 2021
...
rfe = RFE(lda_model, n_features_to_select=n_features_to_select)
...
print("Training set score for LDA: %f" % rfe.score(X_train_scaled, Y_train))
print("Testing  set score for LDA: %f" % rfe.score(X_test_scaled, Y_test ))
...
# Fitting the training data
X_qda = qda_model.fit(X_train_scaled, Y_train)
...
print("Training set score for QDA: %f" % qda_model.score(X_train_scaled, Y_train))
print("Testing  set score for QDA: %f" % qda_model.score(X_test_scaled, Y_test ))
